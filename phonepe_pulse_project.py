...
icon = Image.open("C:\\Users\\DRACO\\Desktop\\phonepe_pulse_data\\Phonepe_Pulse_Data_Visualization-main\\Data\\ICN.png")
...
# MENU 1 - HOME
if selected == "Home":
    st.image("C:\\Users\\DRACO\\Desktop\\phonepe_pulse_data\\Phonepe_Pulse_Data_Visualization-main\\Data\\img.png")
    ...
    with col2:
        st.image("C:\\Users\\DRACO\\Desktop\\phonepe_pulse_data\\Phonepe_Pulse_Data_Visualization-main\\Data\\home.png")
...
if selected == "Top Charts":
    ...
    if Type == "Transactions":
        ...
        with col2:
            ...
            mycursor.execute(
                f"select district , sum(Count) as Total_Count, sum(Amount) as Total from map_transaction where year = {Year} and quarter = {Quarter} group by district order by Total desc limit 10")
        ...
        with col3:
            ...
            mycursor.execute(
                f"select pincode, sum(Transaction_count) as Total_Transactions_Count, sum(Transaction_amount) as Total from top_transaction where year = {Year} and quarter = {Quarter} group by pincode order by Total desc limit 10")
    ...
    if selected == "About":
        ...
        with col2:
            ...
            st.write(" ")
            st.write(" ")
            st.image("C:\\Users\\DRACO\\Desktop\\phonepe_pulse_data\\Phonepe_Pulse_Data_Visualization-main\\Data\\Pulseimg.jpg")